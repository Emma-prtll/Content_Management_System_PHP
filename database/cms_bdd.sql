...
-- Listage des données de la table cmsv1.genre : ~14 rows (environ)
...
-- Listage des données de la table cmsv1.movie : ~2 rows (environ)
REPLACE INTO `movie` (`movie_id`, `movie_name`, `movie_date`, `movie_director`) VALUES
	(1, 'Titanic', '2025-06-12', 'moi'),
	(2, 'X-men Apocalypse', '2023-06-18', 'DiCaprio');

-- Listage des données de la table cmsv1.posts : ~5 rows (environ)
...
-- Listage des données de la table cmsv1.users : ~3 rows (environ)
