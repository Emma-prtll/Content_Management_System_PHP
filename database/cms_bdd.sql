...
-- Listage des données de la table cms_bdd.genre : ~0 rows (environ)
...
-- Listage des données de la table cms_bdd.movie : ~0 rows (environ)
...
-- Listage des données de la table cms_bdd.posts : ~0 rows (environ)
...
-- Listage des données de la table cms_bdd.users : ~0 rows (environ)
